...
response.write('<html><head><meta name="viewport" content="width=device-width, initial-scale=1"><style> .container{position:relative;max-width:600px;height:400px; border:solid 10px;border-radius:10px;-webkit-overflow-scrolling:touch; overflow-y:scroll;} .interface{position:absolute;bottom:0px;width:100%;height:60px;background-color:LightGray;z-index:3;opacity:0.9;overflow:hidden;} .searchbar{display:inline-block;width:50%;height:50px;top:10px;background-color:AliceBlue;} .interface.Large{opacity:1;height:200px;} iframe{position:relative;width:100%;height:100%;border:solid:30px;} </style> </head><body><div> Search<form action="/query"><input  class="searchbar" type=text name:"query" value="'+query+'"></form></div><div id=c>');
